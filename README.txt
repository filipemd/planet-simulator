...
Ele não tem quase nada, então fique livre para fazer modificações como:
 ...
 - Adicionar outros planetas além de Mercúrio e Terra;
 - Adicionar outras simulações;
 - Deixar a interface mais intuitiva;
 - Deixar a simulação mais realista.

É só criar uma fork do GitHub, adoraria ver seu trabalho. O código está disponível na licensa MIT.